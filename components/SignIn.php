...
<!-- <div class="formImage">
    ...
    <div class="heading">
        ...
        <div class="form_elements">
            ...
            <input type="email" name="email" id="email" placeholder="Enter your E-mail" value="<?php if(isset($_COOKIE["remember_user"])){echo $_COOKIE["remember_user"];}?>" class="input" />
        ...
        <?php
            if(isset($_POST['Submit'])){
                ...
                $sql = "SELECT id, user_name, user_age, user_phoneNum FROM `users_table` WHERE user_email = '{$user_email}' AND user_password = '{$user_password}'";
